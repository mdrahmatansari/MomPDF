...
export type ContentStreamOperand = number | string | NameOperand | HexStringOperand | LiteralStringOperand | ContentStreamOperand[] | {
    [key: string]: ContentStreamOperand;
};
export type NameOperand = {
    type: 'name';
    value: string;
};
export type HexStringOperand = {
    type: 'hexString';
    bytes: Uint8Array;
};
export type LiteralStringOperand = {
    type: 'string';
    bytes: Uint8Array;
};
